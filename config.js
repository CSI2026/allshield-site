...
(()=>{
  const scripts=[
    ...
    ['allshieldOnboardingRouterLoader','./onboarding-router-2026-08-27.js?v=2026.08.31.015'],
    ...
    ['allshieldCommercialAcademyLoader','./academy-commercial-loader-2026-08-31.js?v=2026.08.31.003']
  ];
