...
ok('weekly 75 threshold',has(source,'agent_weekly_threshold:75'));
ok('no old agent bonuses',!has(source,'agent_monthly:[{threshold:250'));
...
ok('coaching recommendations',has(source,'coaching_opportunity_detection')&&has(source,'threshold_near_miss_detection'));
