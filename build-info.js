window.ALLSHIELD_BUILD_INFO={
  ...
  certification:{
    ...
    tiktok_sandbox_draft_upload:'LIVE USER TEST PASS — REAL PUBLISH ID',
    tiktok_sandbox_private_direct_post:'LIVE USER TEST PASS — SELF_ONLY REAL PUBLISH ID',
    ...
    tiktok_professional_connection:'CONNECTED PARTIAL — REAL OAUTH + IDENTITY PASS',
    x_professional_engagement_verification:'PASS',
    x_mentions_readiness_gate:'PASS',
    x_reply_permission_gate:'PASS',
    tiktok_account_stats_verification:'LIVE PASS',
