window.ALLSHIELD_BUILD_INFO={
  ...
  current_build:'B2026.08.28.026',
  label:'Production B026 — Explicit Agent Invite Email + Complete Manual Agent Onboarding + Internal Agent Identity',
  completion_release:'2026.08.28.009',
  channel:'production',
  released_at:'2026-08-28',
  certification:{
    manual_agent_onboarding:'18/18 PASS',
    esign:'28/28 PASS',
  ...
  changes:[
    'Owner Portal Team Accounts now clearly shows Agent Email / Invite Email (Required)',
