...
try{
  ...
  const buttonText=await page.locator('.career-sizzle-final-button').innerText();rec('Careers card is final playable experience',buttonText.includes('Live 3-Minute Experience')&&buttonText.includes('Narrated')&&buttonText.includes('15 scenes'),buttonText.slice(0,220).replace(/\n/g,' | '));
