...
const all=[core,back,academy,read('phase16-owner-live-dashboard.js'),read('phase16-owner-support.js'),ai,read('phase16-social-production.js')].join('\n');
...
for(const f of ['backend.js','build-info.js','config.js','phase16-build-002.js','phase16-crm.js','phase16-owner-live-dashboard.js','phase16-owner-support.js','phase16-live-backoffice.js','phase16-agent-academy-production.js','phase16-academy-admin.js','phase16-production-core.js','phase16-ai-command-production.js','phase16-agent-live-essentials.js','phase16-social-production.js','responsive-ui.js']) execFileSync(process.execPath,['--check',f],{stdio:'inherit'});
console.log('Owner Portal completion contract: PASS (23/23 routes; live AI command center; responsive portal system; approved B021 baseline preserved)');
