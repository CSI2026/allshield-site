...
function install(){
  ...
  window.registerAllshieldView('owner','states',()=>{currentOwnerView='states';return renderLicensing(ownerMain());});
}
install();
})();
